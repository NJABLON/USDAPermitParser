...
def read_pdf(filename):	
	...
	for line in permitConditions:
		...
		and line[:11] != 'Agriculture' and 'http' not in line:
			...
			if line.startswith('This permit authorizes') and not line.startswith('This permit authorizes the'):
				authFilled = False
				counter = 0
...
if __name__ == '__main__':
	...
	genus_list = ['Achroia','Achromobacter','Achromobacter','Achromobacter','Acidovorax','Acinetobacter','Acinetobacter','Acremonium','Acremonium','Acremonium','Acremonium','Acrosternum','Actinomucor','Aeromicrobium','Agreia','Agrobacterium','Agrobacterium','Agromyces','Alpinaria','Altererythrobacter','Alternaria','Alternaria','Aphis','Aphis','Arthrobacter','Arthrobacter','Arthrobacter','Ascochyta','Ascochyta','Ascochyta','Aspergillus','Aspergillus','Aspergillus','Aureimonas','Aureobasidium','Azorhizobium','Azorhizobium','Azospirillum','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacillus','Bacteria','Blastoschizomyces','Bosea','Bosea','Brachybacterium','Bradyrhizobium','Bradyrhizobium','Bradyrhizobium','Bradyrhizobium','Bradyrhizobium','Brevibacillus','Brevibacillus','Brevibacillus','Brevibacillus','Brevibacillus','Brevundimonas','Brochothrix','Burkholderia','Burkholderia','Burkholderia','Burkholderia','Candida','Caulobacter','Cedecea','Cellulomonas','Cellulomonas','Cellulomonas','Cellulosimicrobium','Chaetomium','Chaetomium','Chaetomium','Chitinophaga','Chitinophaga','Chitinophaga','Chitinophaga','Chryseobacterium','Chryseobacterium','Chryseobacterium','Chungangia','Citricoccus','Citrobacter','Cladosporium','Cladosporium','Cladosporium','Cladosporium','Cladosporium','Cladosporium','Clavibacter','Cochliobolus','Cochliobolus','Cohnella','Colaspis','Colletotrichum','Colletotrichum','Colletotrichum','Collimonas','Comamonas','Coniochaeta','Coniochaeta','Coniochaeta','Coniochaeta','Coniochaeta','Coniochaeta','Coniothyrium','Cryobacterium','Curtobacterium','Curtobacterium','Curtobacterium','Curtobacterium','Curtobacterium','Curvularia','Curvularia','Curvularia','Dermacoccus','Devosia','Diabrotica','Diaporthe','Dietzia','Diplodia','Dyadobacter','Dyella','Edenia','Emericellopsis','Engyodontium','Enhydrobacter','Ensifer','Enterobacter','Enterobacter','Enterobacter','Enterobacter','Enterobacter','Enterococcus','Epichloe','Epicoccum','Erwinia','Erwinia','Escherichia','Euschistus','Exiguobacterium','Exophiala','Falsirhodobacter','Fictibacillus','Flavobacterium','Frigoribacterium','Fungi','Fusarium','Fusarium','Fusarium','Fusarium','Geodermatophilus','Geotrichum','Gibellulopsis','Glomus','Gluconacetobacter','Gluconobacter','Gordonia','Hanseniaspora','Helicoverpa','Herbaspirillum','Herbiconiux','Heterodera','Janibacter','Janthinobacterium','Kaistia','Kineococcus','Kitasatospora','Klebsiella','Kocuria','Kocuria','Kosakonia','Labedella','Labrys','Lachnoclostridium','Lactococcus','Leclercia','Leifsonia','Lelliottia','Leptosphaerulina','Leucobacter','Luteibacter','Lygus','Lysinibacillus','Lysinibacillus','Lysinibacillus','Lysobacter','Magnaporthe','Magnaporthe','Massarina','Massilia','Mayetiola','Meloidogyne','Meloidogyne','Mesorhizobium','Methylobacterium','Microbacterium','Microbacterium','Microbacterium','Micrococcus','Micrococcus','Microsphaeropsis','Moraxella','Mucilaginibacter','Mucor','Mucor','Mucor','Mycetocola','Mycobacterium','Mycosphaerella','Neisseria','Neopestalotiopsis','Neorhizobium','Nezara','Nigrospora','Nocardia','Nocardioides','Novosphingobium','Ochrobactrum','Ochrobactrum','Paecilomyces','Paenibacillus','Paenibacillus','Paenibacillus','Paenibacillus','Paenibacillus','Paenibacillus','Paenibacillus','Paenisporosarcina','Pantoea','Pantoea','Pantoea','Pantoea','Pantoea','Paraboeremia','Paraburkholderia','Paracoccus','Paraconiothyrium','Paraphaeosphaeria','Pedobacter','Pelomonas','Penicillium','Penicillium','Penicillium','Periconia','Periconia','Pestalotiopsis','Pestalotiopsis','Pestalotiopsis','Phialemonium','Phomopsis','Phycicoccus','Phyllobacterium','Phytobacter','Pithomyces','Plantibacter','Pratylenchus','Pratylenchus','Pratylenchus','Pratylenchus','Pratylenchus','Pratylenchus','Pratylenchus','Promicromonospora','Promicromonospora','Providencia','Pseudaminobacter','Pseudarthrobacter','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudomonas','Pseudoxanthomonas','Psychrobacter','Pythium','Raoultella','Raoultella','Rathayibacter','Rhizobium','Rhizobium','Rhizobium','Rhizobium','Rhizoctonia','Rhodanobacter','Rhodococcus','Rhodoligotrophos','Rhopalosiphum','Rhopalosiphum','Rotylenchulus','Saccharibacillus','Sagenomella','Sanguibacter','Schizothecium','Serratia','Setosphaeria','Setosphaeria','Shimazuella','Shinella','Siphonobacter','Solibacillus','Sphingobacterium','Sphingobacterium','Sphingobium','Sphingobium','Sphingomonas','Sphingomonas','Sphingomonas','Sphingomonas','Sphingopyxis','Spodoptera','Sporosarcina','Stagonosporopsis','Staphylococcus','Stenocarpella','Stenotrophomonas','Stenotrophomonas','Stenotrophomonas','Stenotrophomonas','Streptococcus','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Streptomyces','Talaromyces','Talaromyces','Terrabacter','Terrabacter','Terribacillus','Terribacillus','Thermomonas','Trichoderma','Trichoderma','Trichoderma','Trichophaea','Variovorax','Variovorax','Verticillium','Vibrissea','Williamsia','Xanthomonas','Xanthomonas']
	species_list = ['grisella','insuavis','spp.','xylosoxidans','sp.','lwoffii','spp.','alternatum','kiliense','sp.','zeae','hilare','elegans','sp.','sp.','larrymoorei','sp.','sp.','rhododendri','sp.','alternata','metachromatica','glycines','gossypii','','sp','sp.','medicaginicola','rabiei','viciae-pannonicae','fumisynnematus','ruber','rugulosus','sp.','iranianum','caulinodans','sp.','brasilense','','amyloliquefaciens','aryabhattai','butanolivorans','circulans','endophyticus','flexus','licheniformis','megaterium','methylotrophicus','mojavensis','pumilus','simplex','sp.','stratosphericus','subtilis','vallismortis','velezensis','','spp.','ssp.','thiooxidans','sp.','diazoefficiens','elkanii','japonicum','sp.','spp.','agri','formosus','laterosporus','sp.','spp.','spp.','sp.','cenocepacia','contaminans','phenazinium','sp.','','sp.','spp.','','humilata','sp.','','','coarctatum','globosum','','ginsengisegetis','sancti','sp.','hominis','spp.','ssp.','sp.','sp.','spp.','cladosporioides','limoniforme','macrocarpum','minourae','oxysporum','tenuissimum','sp.','heterostrophus','sp.','spp.','brunnea','coffeanum','dematium','sp.','sp.','spp.','cateniformis','endophytica','ligniaria','nepalica','polymorpha','savoryi','prosopidis','sp.','','citreum','flaccumfaciens','oceanosedimentum','pusillum','protuberata','sp.','spicifera','sp.','sp.','virgifera','eres','sp.','medicaginis','sp.','sp.','gomezpompae','pallida','album','sp.','sp.','asburiae','cloacae','cowanii','sp.','spp.','spp.','festucae','nigrum','persicina','spp.','','servus','','oligosperma','sp.','sp.','spp.','sp.','','graminearum','oxysporum','solani','virguliforme','spp.','','nigrescens','intraradices','liquefaciens','cerinus','','uvarum','zea','spp.','sp.','glycines','sp.','sp.','species','sp.','gansuensis','sp.','rhizophila','spp.','cowanii','sp.','sp.','sp.','sp.','adecarboxylata','sp.','amnigena','australis','sp.','sp.','lineolaris','','sp.','sphaericus','spp.','grisea','oryzae var. oryzae','igniaria','spp.','destructor','arenaria','incognita','spp.','spp.','oxydans','sp.','testaceum','luteus','spp.','olivacea','','sp.','bainieri','fragilis','racemosus','sp.','','graminicola','','sp.','sp.','viridula','oryzae','spp.','spp.','sp.','anthropi','spp.','lilacinus','glycanilyticus','peoriae','polymyxa','sp.','spp.','taichungensis','terrigena','','','agglomerans','ananatis','dispersa','sp.','camelliae','caledonica','sp.','brasiliense','sporulosa','spp.','spp.','melanoconidium','mononematosum','oxalicum','byssoides','macrospinosa','endophytica','neglecta','versicolor','inflatum','chimonanthi','spp.','spp.','spp.','cynodontis','','alleni','brachyurus','hexincisus','neglectus','penetrans','scribneri','zeae','kroppenstedtii','spp.','spp.','spp.','sp.','abietaniphila','chlororaphis','corrugata','fluorescens','frederiksbergensis','marginalis','moraviensis','oleovorans','oryzihabitans','protegens','rhodesiae','sp.','spp.','straminea','vranovensis','spp.','sp.','ultimum','','sp.','sp.','pusense','sp.','spp.','tropici','solani','spp.','sp.','spp.','maidis','padi','reniformis','spp.','verticillata','sp.','inaequale','sp.','monoceras','turcica','spp.','spp.','spp.','','spp.','zeae','spp.','yanoikuyae','sanguinis','spp.','yanoikuyae','zeae','spp.','frugiperda','','cucurbitacearum','spp.','maydis','maltophilia','pavanii','rhizophila','spp.','spp.','canus','ciscaucasicus','fulvissimus','kathirae','lydicus','parvus','rishiriensis','sp.','spp.','xanthochromogenes','flavus','pinophilus','','spp.','spp','spp,','spp.','atroviride','harzianum','spirale','hemisphaerioides','ginsengisoli','spp.','dahliae','truncorum','sp.','sp.','campestris']
